...
async def query_timestamps(
    ...
    keyword: Optional[str] = Query(None, description="关键词搜索 (模糊匹配ASR文本)"),
...
@router.get("/detail/{record_id}", response_model=AudioDetailResponse)
async def get_record_detail(
    ...
    """
    engine = get_query_engine(db)
    result = engine.get_record_detail(record_id)
